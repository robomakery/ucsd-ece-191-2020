...
setup: build
	xhost +local:docker
	docker run $(GENERAL_OPTIONS) $(GUI_OPTIONS) devenv:latest bash -c "catkin_make bash && cd /code/robot_ws && source /opt/ros/melodic/setup.bash && source /code/robot_ws/devel/setup.bash"
